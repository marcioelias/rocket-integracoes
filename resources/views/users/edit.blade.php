    ...
    <form method="POST" action="{{ route('users.update', $user->id) }}">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <x-form.input-text label="Nome" field="name" :value="$user->name" />
            </div>
            <div class="form-group col-md-6">
                <x-form.input-email label="E-mail" field="email" :value="$user->email" />
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-4">
                <x-form.input-text label="Usuário" field="username" disabled="disabled" :value="$user->username" />
            </div>
            <div class="form-group col-md-4">
